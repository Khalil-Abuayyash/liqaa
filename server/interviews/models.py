...
class Availability(models.Model):
    ...
    #     # These vaildations for the dates and times in the past
    #     if self.end_time <= self.start_time:
    #         raise ValidationError("End time must occur after the start time.")
        
    #     # This case the vaildate the availability not in the past.
    #     if self.available_date < date.today():
    #         raise ValidationError("Availability cannot be set for past dates.")
    ...
    #     # overlapping availabilities cases 
    #     # This case when the user want to add availability while it is already exists
    ...
    #     ).exists():
    #         raise ValidationError("An availability with the same time range already exists.")
        
    #     # This case when the user wants to add availability before the start_time and after the end_time
    #     if Availability.objects.filter(
    #         user=self.user,
    #         available_date=self.available_date,
    ...
    #     ).exists():
    #         raise ValidationError("New time fully overlaps an existing availability")
        
    #     # This case when the user wants to add availability before the start_time and before the end_time
    #     if Availability.objects.filter(
    #         user=self.user,
    #         available_date=self.available_date,
    #         start_time__lt=self.start_time,
    ...
    #     ).exists():
    #         raise ValidationError("New availability starts before and ends during an existing one")
        
    #     # This case when the user wants to add availability before the end_time
    #     if Availability.objects.filter(
    #         user=self.user,
    #         available_date=self.available_date,
    #         start_time=self.start_time,
    #         end_time__lt=self.end_time
    #     ).exists():
    #         raise ValidationError("New availability ends during an existing one")
        
    #     # This case when the user wants to add availability after the start_time
    #     if Availability.objects.filter(
    #         user=self.user,
    #         available_date=self.available_date,
    ...
    #         end_time=self.end_time
    #     ).exists():
    #         raise ValidationError("New availability starts during an existing one")
